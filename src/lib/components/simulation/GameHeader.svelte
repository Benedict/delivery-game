...
<div class="bg-amber-100 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] p-6 mb-6 max-w-5xl mx-auto">
  ...
  <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
    <div class="bg-sky-200 border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] p-4">
      <div class="text-xs font-bold text-sky-900 mb-1">💪 CAPACITY</div>
      <div class="text-2xl font-black text-black">{metrics.capacity}</div>
    </div>

    <div class="bg-emerald-200 border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] p-4">
    ...
    <div class="bg-rose-200 border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] p-4">
    ...
    <div class="bg-violet-200 border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] p-4">
    ...
    <div class="bg-amber-200 border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] p-4">
    ...
    <div class="bg-teal-200 border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] p-4">
